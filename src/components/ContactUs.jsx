...
export default function ContactUs() {
  return (
    <div className="flex justify-between md:h-[180px] md:px-10 ">
      <div></div>
      <div className="flex md:flex-col gap-1 md:items-end md:my-2 right-2 fixed bottom-1/2 md:top-1/2">
        <div className="rounded-xl h-[60px] md:p-1  flex  md:w-[450px] border bg-white shadow-md ">
        ...
        <div className="rounded-xl items-center flex h-[60px]  md:w-[450px] py-6 px-3 md:p-1 shadow-md bg-white border ">
