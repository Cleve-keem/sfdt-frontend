  ...
  return (
    <div className="flex justify-between md:px-10 ">
      ...
      <div className="flex md:flex-col gap-1 md:items-end md:my-2 right-2 fixed bottom-1/2 md:top-1/2">
        <div className="rounded-xl h-[60px] md:h-[70px] pt-2 md:px-1 flex md:items-center md:w-[450px] border bg-white shadow-md ">
        ...
        <div className="rounded-xl flex h-[60px] md:h-[70px] md:w-[450px] py-6 px-3 md:p-1 shadow-md bg-white border md:items-center">
