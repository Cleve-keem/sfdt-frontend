...
export default function ContactUs() {
  return (
    <div className="flex justify-between bg-black text-black  px-10">
      <div></div>
      <div className="flex flex-col gap-1 items-end my-2 w-[10px] ">
        <div className="rounded-2xl flex w-[500px] p-2 border bg-white shadow-md">
        ...
        <div className="rounded-2xl flex w-[500px] p-1 shadow-md bg-white border ">
